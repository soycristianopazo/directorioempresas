"""Atributos dinámicos (EAV tipado) + vista de herencia

Revision ID: 0016
Revises: 0015

El esquema vive en ../sql/0016_attributes.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0016_attributes.sql"
