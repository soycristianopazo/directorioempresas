"""Taxonomía de oferta e industrias (diseño dual-eje)

Revision ID: 0014
Revises: 0013

El esquema vive en ../sql/0014_taxonomy_and_industries.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0014_taxonomy_and_industries.sql"
