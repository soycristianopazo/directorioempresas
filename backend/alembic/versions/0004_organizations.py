"""Organizaciones, capacidades e identificadores tributarios

Revision ID: 0004
Revises: 0003

El esquema vive en ../sql/0004_organizations.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0004_organizations.sql"
