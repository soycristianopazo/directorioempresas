"""Extensiones, esquema app, ENUMs raíz y convenciones

Revision ID: 0001
Revises: (ninguna: es la primera)

El esquema vive en ../sql/0001_foundation.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0001_foundation.sql"
