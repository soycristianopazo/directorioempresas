"""Datos de referencia: países, monedas, unidades, idiomas

Revision ID: 0011
Revises: 0010

El esquema vive en ../sql/0011_reference_data.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0011_reference_data.sql"
