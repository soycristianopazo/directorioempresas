"""Auditoría inmutable y outbox de eventos

Revision ID: 0006
Revises: 0005

El esquema vive en ../sql/0006_audit_and_events.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0006_audit_and_events.sql"
