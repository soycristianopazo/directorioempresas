"""Divisiones administrativas + trigger genérico de jerarquías

Revision ID: 0012
Revises: 0011

El esquema vive en ../sql/0012_admin_divisions.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0012_admin_divisions.sql"
