"""Helper de RLS: permisos de plataforma sin organización

Revision ID: 0018
Revises: 0017

El esquema vive en ../sql/0018_taxonomy_rls_helpers.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0018_taxonomy_rls_helpers.sql"
