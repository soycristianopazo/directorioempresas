"""Motor de completitud de perfil

Revision ID: 0027
Revises: 0026

El esquema vive en ../sql/0027_completion_pct.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0027_completion_pct.sql"
