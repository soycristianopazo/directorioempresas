"""Funciones helper de Row Level Security

Revision ID: 0007
Revises: 0006

El esquema vive en ../sql/0007_rls_helpers.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0007_rls_helpers.sql"
