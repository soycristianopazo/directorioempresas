"""RLS de planes y facturación (fase 8.10)

Revision ID: 0072
Revises: 0071

El esquema vive en ../sql/0072_fase8_rls_billing.sql.
"""
...
SQL_FILE = (
    Path(__file__).resolve().parent.parent / "sql" / "0072_fase8_rls_billing.sql"
)
