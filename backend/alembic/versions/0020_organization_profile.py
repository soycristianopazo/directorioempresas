"""Perfil extendido de organización

Revision ID: 0020
Revises: 0019

El esquema vive en ../sql/0020_organization_profile.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = (
    Path(__file__).resolve().parent.parent / "sql" / "0020_organization_profile.sql"
)
