...
El esquema vive en ../sql/0025_certifications.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0025_certifications.sql"
