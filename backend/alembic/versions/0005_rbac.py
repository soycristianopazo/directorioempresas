"""Membresías, roles, permisos e invitaciones

Revision ID: 0005
Revises: 0004

El esquema vive en ../sql/0005_rbac.sql. Buena parte de él —policies de RLS,
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0005_rbac.sql"
