"""RLS de búsqueda, listas guardadas y analítica

Revision ID: 0033
Revises: 0032

El esquema vive en ../sql/0033_fase4_rls.sql.
"""
...
SQL_FILE = Path(__file__).resolve().parent.parent / "sql" / "0033_fase4_rls.sql"
